...
if grep -RniE --exclude-dir=.git --exclude-dir=target --exclude-dir=node_modules --exclude-dir=.pnpm-store --exclude='UPSTREAM.md' --exclude='release-check.sh' --exclude='.git' \
